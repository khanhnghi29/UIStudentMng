                                ...
                                <form autoComplete="off" onSubmit={handleFormSubmit}>
                                    ...
                                    <div className='form-group'>
                                        ...
                                        <div className="input-group mb-3 mt-2">
                                            ...
                                            <input type="email" className="form-control" placeholder="Username" name="email" value={inputs.email} onChange={handleChangeInput} aria-label="Username" aria-describedby="basic-addon1" required />
                                        </div>
                                    </div>
                                    ...
                                    <div className='form-group'>
                                        ...
                                        <div className="input-group mb-3 mt-2">
                                            ...
                                            <input type="password" className="form-control" placeholder="password" name="password" value={inputs.password} onChange={handleChangeInput} aria-label="Username" aria-describedby="basic-addon1" required />
                                        </div>
                                    </div>
