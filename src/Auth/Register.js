...
import { User_BASE_URL } from '../App.js';
...
export default function Register() {
    ...
    function handleFormSubmit(event) {
        ...
        axios.post(User_BASE_URL + '/Registration', data)
            .then(res => {
                            ...
                            <div className="card-body">
                                <form className="row g-3" onSubmit={handleFormSubmit}>
                                    <div className="col-md-6">
                                        ...
                                        <input type="email" className="form-control" id="inputEmail4" name='email' value={inputs.email} onChange={handleChangeInput} placeholder='Ex. am.khanhnghi29@gmail.com' required />
                                    </div>
                                    <div className="col-md-6">
                                        <label htmlFor="userName" className="form-label">user Name <span className="text-danger d2">*</span></label>
                                        <input type="text" className="form-control" id="userName" name='name' value={inputs.name} onChange={handleChangeInput} placeholder='Ex. K. H. Senator' required />
                                    </div>
                                    <div className="col-md-6">
                                        <label htmlFor="inputPassword4" className="form-label">Password <span className="text-danger d2">*</span></label>
                                        <input type="password" className="form-control" id="inputPassword4" name='password' value={inputs.password} onChange={handleChangeInput} placeholder='password' required />
                                    </div>
                                    <div className="col-md-6">
                                        <label htmlFor="mobileNumber" className="form-label">Mobile number <span className="text-danger d2">*</span></label>
                                        <input type="text" className="form-control" id="mobileNumber" name='phoneNumber' value={inputs.phoneNumber} onChange={handleChangeInput} placeholder='Ex. 0775311974' required />
                                    </div>
                                    <div className="col-12">
                                        <label htmlFor="Address" className="form-label">Address</label>
                                        <textarea className="form-control" id="Address" name="address" value={inputs.address} onChange={handleChangeInput} placeholder="Ex: 294/5, Sharingan" rows="3" required></textarea>
                                    </div>
