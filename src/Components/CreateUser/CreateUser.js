...
import Logo from './Forms-Create.svg';
...
export default function CreateUser() {
    ...
    function handleFormSubmit(event) {
        ...
        axios.post(Student_BASE_URL + '/InsertStudent', data)
            .then(res => {
                        ...
                        <form action='' onSubmit={handleFormSubmit} autoComplete="off">
                            <div className="row mb-3">
                                <div className="col-xs-12 col-sm-12 col-md-6">
                                    ...
                                    <input type="text" name="firstName" id="" value={inputs.firstName} onChange={handleChangeInput} className="form-control" required />
                                </div>

                                <div className="col-xs-12 col-sm-12 col-md-6">
                                    <label htmlFor="" className="form-label">Last Name</label>
                                    <input type="text" name="lastName" id="" value={inputs.lastName} onChange={handleChangeInput} className="form-control" required />
                                </div>
                            </div>
                            ...
                            <div className="row mb-3">
                                <div className="col-xs-12 col-sm-12 col-md-6">
                                    ...
                                    <input type="text" name="email" id="" value={inputs.email} onChange={handleChangeInput} className="form-control" required />
                                </div>

                                <div className="col-xs-12 col-sm-12 col-md-6">
                                    <label htmlFor="" className="form-label">Phone Number </label>
                                    <input type="text" name="contact" id="" value={inputs.contact} onChange={handleChangeInput} className="form-control" required />
                                </div>
                            </div>
